...
class QuickTest(QWidget):
    def __init__(self, stack, text="None"):
        ...
        self.initUI(text)
        self.set_connection(SerialConnection(port="COM6", baudrate=115200))
        ...
        try:
           ...
           # IMU sample with timestamp in milliseconds
            ...
            if self.last_timestamp is not None:
                ...
                accel_x = (data["accel_x"] -1 ) *9.81
                accel_y = (data["accel_y"] -1 ) *9.81
                ...
                # Update position
                self.position_x += self.velocity_x * dt + 0.5 *accel_x * dt ** 2
                self.position_y += self.velocity_y * dt + 0.5 *accel_y * dt ** 2

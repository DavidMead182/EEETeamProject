...
#if defined(__AVR_ATmega328P__)  // Arduino Uno with RFM69 module
  #define RFM69_CS    10  // Chip Select
  #define RFM69_INT    2  // Interrupt pin (Uno supports INT0 on D2)
  #define RFM69_RST    9  // Reset pin 
  #define LED         13  // Built-in LED on Uno
#endif
